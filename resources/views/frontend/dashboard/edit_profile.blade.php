...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.7.1/jquery.min.js"></script>
 ...
 <div class="col-lg-12 col-md-6">
        <div class="form-group">
            <label>User Profile Photo <span class="required">*</span></label>
    ...
    <div class="col-lg-12 col-md-6">
        <div class="form-group">
            ...
            <img id="showImage" src="{{( !empty($profileData->photo)) ? url('upload/user_images/'.$profileData->photo) : url('upload/no_image.png')}}" alt="Admin" class="rounded-circle p-1 bg-primary" width="80"/>
        </div>
    </div>
