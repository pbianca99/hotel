...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.7.1/jquery.min.js"></script>
                        ...
                        <div class="room-details-article">
                            <div class="room-details-slider owl-carousel owl-theme">
                                ...
                                <div class="room-details-item">
                                    <img src="{{asset('upload/room_images/multi_images/'.$image->multi_image)}}" alt="Images">
                                </div>
                                @endforeach
                            </div>
                            ...
                            <div class="room-details-title">
                                ...
                                <ul>
                                    ...
                                    <li>
                                       <b> Tarif Standard : {{$roomdetails->price}} RON / Noapte</b>
                                    </li> 
   ...
   <div class="side-bar-plan">
                                <h3>Facilități incluse în Planul Standard</h3>
                                <ul>
...
<div class="row"> 
 ...
 <div class="services-bar-widget">
                                <h3 class="title">Detalii camera</h3>
        <div class="side-bar-list">
            <ul>
               <li>
                    <a href="#"> <b>Capacitate : </b> {{$roomdetails->room_capacity}} Persoane <i class='bx bxs-cloud-download'></i></a>
                </li>
                <li>
                     <a href="#"> <b>Dimensiuni camera : </b> {{$roomdetails->size}}m2 <i class='bx bxs-cloud-download'></i></a>
                </li>
 ...
 <div class="services-bar-widget">
        ...
        <div class="side-bar-list">
            <ul>
               <li>
                    <a href="#"> <b>Vedere : </b> {{$roomdetails->view}} <i class='bx bxs-cloud-download'></i></a>
                </li>
                <li>
                     <a href="#"> <b>Tipul patului : </b> {{$roomdetails->bed_style}}  <i class='bx bxs-cloud-download'></i></a>
                </li>
                            ...
                            <div class="room-details-review">
                                ...
                                <form >
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12">
                                            <div class="form-group">
                                                <textarea name="message" class="form-control"  cols="30" rows="8" required data-error="Write your message" placeholder="Scrie o recenzie.... "></textarea>
                                            </div>
                                        </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-7 col-md-8 p-0">
                                    <div class="room-card-content">
                                        ...
                                        <span>>{{$item->price}} RON / Noapte </span>
                                        <div class="rating">
