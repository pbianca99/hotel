...
<body class="">
	...
	<div class="wrapper">
							...
							<div class="card-body p-sm-5">
								<div class="">
									<div class="mb-3 text-center">
										<img src="{{asset('backend/assets/images/logo-icon.png')}}" width="120" alt="">
									</div>
									<div class="text-center mb-4">
										<h5 class="">Luna Hotel - Admin</h5>
        ...
        <form class="row g-3" method="POST" action="{{ route('login') }}">
            ...
            <div class="col-12">
                <label for="inputEmailAddress" class="form-label">Email/Nume/Telefon</label>
                <input type="text" name="login" class="form-control @error('login') is-invalid
                    @enderror" id="login" placeholder="name@email.com">
                    @error('login')
