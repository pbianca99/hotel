					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Update Booking Banner</li>
							</ol>
						</nav>
					</div>
				</div>
									...
									<div class="card-body">
										<div class="row mb-3">
											...
											<div class="form-group col-sm-9 text-secondary">
												<input type="text" name="short_title" class="form-control" value="{{$banner->short_title}}" />
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-sm-3">
										...
										<div class="row mb-3">
											...
											<div class="form-group col-sm-9 text-secondary">
												<textarea class="form-control" id="input40" name="description"
                                                rows="3" placeholder="description">{{$banner->description}}</textarea>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <img id="showImage" src="{{asset($banner->banner_image)}}" alt="Room Photo" class="rectangle p-1" style="width: 250px; height: 200px; border: 2px solid purple;"/>
											</div>
										</div>
