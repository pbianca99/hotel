							...
							<div class="col-lg-8">
								<div class="card">
									...
									<div class="card-body">
										...
										<div class="row mb-3">
											<div class="col-sm-3">
												<h6 class="mb-0">Status Camera</h6>
											</div>
											<div class="col-sm-9 text-secondary">
                                            <select name="status" id="input7" class="form-select">
				                                <option selected="">Selecteaza status...</option>
				                                <option value= "Disponibila" {{$editRoomNo->status == 'Disponibila'?'selected':''}}>Disponibila</option>
			                                	<option value= "Indisponibila" {{$editRoomNo->status == 'Indisponibila'?'selected':''}}>Indisponibila</option>
		                                	</select>
											</div>
										</div>
